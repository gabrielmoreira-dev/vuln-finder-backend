...
const buildLocalDataSources = _ => {
  ...
  return { customerLDS, userLDS, professionalLDS, reportLDS }
}
...
const buildRepositories = _ => {
  ...
  return { customerRepository, userRepository, professionalRepository, reportRepository }
}

const { vulnerabilityRDS } = buildRemoteDataSources()
const { customerLDS, userLDS, professionalLDS, reportLDS } = buildLocalDataSources()
const { customerRepository, userRepository, professionalRepository, reportRepository } = buildRepositories()
...
const buildInsertReportUC = _ => new InsertReportUC({ reportRepository })
